...
{   
    ...
    before(async function(){
        ...
        Singleswap = await ethers.getContractFactory("SingleSwap");
        deploy = await Singleswap.deploy();
...
it("Single Swap", async function () {
  ...
  it("Single Swap Output", async function(){
    ...
    await deploy.swapExactOutputSingle(DaiamountOut, WethMaximumIn);
